...
var author$project$Giphy$gifDecoder = A2(
	elm$json$Json$Decode$field,
	'data',
	A2(elm$json$Json$Decode$field, 'image_url', elm$json$Json$Decode$string));
var author$project$Types$GotGif = function (a) {
	return {$: 'GotGif', a: a};
};
...
var author$project$Giphy$getRandomCatGif = elm$http$Http$get(
	{
		expect: A2(elm$http$Http$expectJson, author$project$Types$GotGif, author$project$Giphy$gifDecoder),
		url: 'https://api.giphy.com/v1/gifs/random?api_key=dc6zaTOxFJmzC&tag=cat'
	});
var author$project$Types$Loading = {$: 'Loading'};
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(author$project$Types$Loading, author$project$Giphy$getRandomCatGif);
};
		...
		if (msg.$ === 'MorePlease') {
			...
			if (result.$ === 'Ok') {
				...
				return _Utils_Tuple2(
					author$project$Types$Success(url),
					elm$core$Platform$Cmd$none);
			} else {
				return _Utils_Tuple2(author$project$Types$Failure, elm$core$Platform$Cmd$none);
			}
		}
	});
var author$project$Types$MorePlease = {$: 'MorePlease'};
